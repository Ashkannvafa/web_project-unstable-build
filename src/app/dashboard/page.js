    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-4 animate-fade-up">
        <div>
          <h1 className="text-4xl font-bold">
            Dashboard <span className="text-gray-600">/</span> <span className="text-cyan-400F bg-clip-text bg-gradient-to-r from-neon-purple to-neon-cyan">{user.name}</span>
          </h1>
          <p className="text-gray-400 mt-2">Overview of your smart contract performance.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <DashboardCard
          ...
          subtext={stats.totalBalance > 0 ? `+${((stats.totalBalance / 100) * 14).toFixed(2)}% this month` : "No earnings yet"}
        ...
        <DashboardCard
          ...
          subtext={stats.totalStreams > 0 ? "Keep growing!" : "Upload tracks to start"}
        ...
        <DashboardCard
          ...
          subtext={stats.activeTracks > 0 ? "Tracks earning" : "No tracks uploaded"}
          icon={<Music size={24} />}
          colorClass="neon-cyan"
          delay="0.3s"
        />
        <DashboardCard
          ...
          subtext={stats.collaborators > 0 ? "Active splits" : "No active splits"}
          icon={<Users size={24} />}
          colorClass="neon-purple"
          delay="0.4s"
        />
        ...
        <div className="glass-panel p-8 rounded-2xl animate-fade-up flex flex-col h-full" style={{ animationDelay: '0.6s' }}>
          <div className="flex justify-between items-center mb-6 border-b border-white/10 pb-4">
            <div>
              ...
              <p className="text-xs text-gray-400">Real-time usage events</p>
            </div>
            <AudioWave />
          </div>
          ...
          <div className="flex-grow relative">
            {liveEvents.length === 0 ? (
              <div className="text-center py-8 flex flex-col items-center justify-center h-full">
                ...
                <p className="text-gray-600 text-xs mt-1">Upload tracks to see live streams</p>
              </div>
            ) : (
